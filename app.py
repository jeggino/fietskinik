...
with right:
    ...
    st.markdown("At moment, the space is available only on Tuesday and Thursday, and three shifts are possible. We wish ask you about your experiences and also some other information that you will find in the form...see you soon!")
